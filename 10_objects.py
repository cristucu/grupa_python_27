...
# cand facem append() la lista_persoane2, schimbarea se reflecta si in dictionarul db, deoarece db["Gadinti"] este o referinta catre lista_persoane2, nu o copie a ei. Astfel, cand modificam lista_persoane2, se modifica si db["Gadinti"].
# daca adaugam people.copy() in add_to_db(), nu mai avem acea referinta
